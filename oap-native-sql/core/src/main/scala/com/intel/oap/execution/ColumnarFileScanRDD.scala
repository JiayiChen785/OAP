 ...
 */
class ColumnarFileScanRDD(
    @transient private val sparkSession: SparkSession,
    readFunction: (PartitionedFile) => Iterator[ColumnarBatch],
  ...
  override def compute(split: RDDPartition, context: TaskContext): Iterator[ColumnarBatch] = {
    ...
    iterator.asInstanceOf[Iterator[ColumnarBatch]] // This is an erasure hack.
  }
